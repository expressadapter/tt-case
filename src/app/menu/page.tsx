      ...
      items: [
        {
          alternativeGroups: [
            ...
            {
              alternationType: 'or',
              items: [{ name: 'Best Of Mezze' }],
            },
            {
              alternationType: 'and/or',
              items: [{ name: 'Creamy Zucchini Soup' }],
            },
          ],
        },
        {
          alternativeGroups: [
            ...
            {
              alternationType: 'or',
              items: [{ name: 'Stir Fried Beef With Bbq' }],
            },
            {
              alternationType: 'or',
              items: [{ name: 'Rigatoni With Parmesan Tomato Sauce' }],
            },
          ],
        },
        {
          alternativeGroups: [
            ...
            {
              alternationType: 'or',
              items: [{ name: 'Apricot Caramel Cake' }],
            },
            {
              alternationType: 'or',
              items: [{ name: 'Selection Of Cheese' }],
            },
            {
              alternationType: 'or',
              items: [{ name: 'Fresh Fruit Salad' }],
            },
          ],
        },
        {
      ...
      items: [
        ...
        { name: 'Honey, Butter' },
        {
          alternativeGroups: [
            ...
            {
              alternationType: 'or',
              items: [{ name: 'Crepe With Vanilla Custard' }],
            },
          ],
        },
